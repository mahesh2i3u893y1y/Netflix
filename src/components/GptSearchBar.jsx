...
// }
  ...
  return (
    <div className="pt-[20%] md:pt-[10%] px-2 flex justify-center items-center">
        <form className="bg-black p-2 w-full md:w-1/2 md:grid md:grid-cols-12" onSubmit={(e) => e.preventDefault()}>
            <input type="text" placeholder={lang[langState].gptSearchPlaceholder}
             className="outline py-2 px-4 w-[75%] md:col-span-9" ref={searchText}/>
            <button className="bg-red-700 py-2 px-4 w-[25%] md:col-span-3
